    ...
    return (
        <>
            <nav>
                <UlStyle>
                    <LiStyle>
                        <NavLink href="/" className="sidebar-navigation-link c-link c-link--block c-link--icon-left">
                    ...
                    <LiStyle>
                        <NavLink href="/about" className="sidebar-navigation-link c-link c-link--block c-link--icon-left">
                            <IconSpan className="c-link__icon">
                                <svg viewBox="0 0 235 234" xmlns="http://www.w3.org/2000/svg" className="rainbow-logo" preserveAspectRatio="xMinYMin meet" width="24" height="24">
            ...
            <nav>
                <UlStyle>
                    ...
                    <LiStyle>
                        <NavLink href="/privacy" className="sidebar-navigation-link c-link c-link--block c-link--icon-left">
                            <IconSpan className="c-link__icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24">
                                    <g transform="translate(4 4)">
                    ...
                    <LiStyle>
                        <NavLink href="/terms" className="sidebar-navigation-link c-link c-link--block c-link--icon-left">
                            <IconSpan className="c-link__icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24">
                                    <g transform="translate(4 4)">
